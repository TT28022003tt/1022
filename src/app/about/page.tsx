    ...
    <div className="w-full py-12 sm:py-16 md:py-20 px-4 sm:px-6 md:px-8 bg-gray-50">
      <div className="max-w-7xl mx-auto">
        ...
        <motion.h1
          ...
          className="text-3xl sm:text-4xl md:text-5xl font-bold text-center text-transparent bg-clip-text bg-gradient-to-r from-[#003294] to-[#00B3FF] uppercase tracking-wide mb-12 p-2"
        >
          GIỚI THIỆU
        </motion.h1>
